...
export const caseStudies = [
	{
		...
		challenge:
			"Low early adoption, unclear onboarding journey for a complex developer workflow tool",
		approach:
			"Led GTM, onboarding strategy, analytics infra with focus on developer experience",
		action:
			"Created persona-based funnels, tracked behavior with PostHog + Retool, built investor narrative",
		results:
		...
		ctaLink:
			"https://oceanic-fireman-8fc.notion.site/Pullflow-From-pre-GTM-to-steady-traction-Rabia-Ahmed-8171faba2e394fa099e512c40cfc1f63",
	},
	{
		...
		challenge:
			"Crowded crypto SERPs, paid CAC climbing 35% QoQ, making customer acquisition unsustainable",
		approach:
			"SEO & Growth Lead, managed a 5‑person squad focused on organic acquisition",
		action:
			"Engineered schema, pillar‑cluster strategy, & community‑driven link‑building via Discord",
		results:
			"Doubled organic traffic within 6 months, increased qualified leads by 35%, while reducing overall customer acquisition costs by 23%",
		learning:
	...
	},
	{
		...
		challenge:
			"Developer docs buried in sub‑folders, weak indexing, and a bottlenecked publishing flow hampering developer adoption",
		approach:
			"Fractional PMM & Webflow builder focused on technical documentation improvements",
		action:
			"Audited doc structure, mapped keyword clusters, set canonical and schema markup, migrated 200+ pages into Webflow CMS",
		results:
			"Increased documentation traffic by 62%, improved search visibility for 20 high-intent keywords, and doubled content publishing velocity",
		learning:
			"Technical documentation is often an overlooked but high-leverage marketing asset that directly impacts product adoption",
		testimonial: {
			quote:
	...
	},
	{
		...
		challenge:
			"High bounce rate on pre‑sale pages, weak story alignment causing poor conversion despite good traffic",
		approach:
			"SEO + Web Lead, owned copy, UX, and funnel testing to improve conversion metrics",
		action:
			"Wrote 25 intent‑driven pages, ran iterative A/B tests, introduced trust badges & demo GIFs",
		results:
