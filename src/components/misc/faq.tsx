...
const faqs = [
	...
	{
		question:
			"Do you work with international clients and accommodate different time zones?",
		answer:
...
export default function Faq() {
	...
	return (
		<section
			className="scroll-mt-24 px-8 md:px-12 pt-12 pb-22 max-w-2xl mx-auto"
			id="faq"
		>
			<div className="pt-20 pb-12">
				<h2 className="text-3xl tracking-tighter font-light lg:text-4xl text-black dark:text-white text-center">
					...
					<span className="block">popular frequent questions</span>
				</h2>
				...
				<ul className="list-none text-black bg-white dark:bg-zinc-900 rounded-3xl divide-y divide-zinc-200 dark:divide-zinc-700 mt-8">
					{faqs.map((faq, index) => (
